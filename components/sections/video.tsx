...
export function Video() {
  ...
  return (
    <section id="video" className="container scroll-mt-20 py-20 sm:py-28">
      ...
      {/* Featured 611k */}
      <Reveal>
        <div className="group relative grid overflow-hidden border-2 border-ink md:grid-cols-[1.1fr_1fr]">
          ...
          <div className="flex flex-col justify-between gap-6 bg-paper p-8">
            <div>
              <span className="border-2 border-ink bg-beam px-2 py-0.5 font-sans text-[10px] font-bold uppercase tracking-wider">
                {featured.theme}
              </span>
            ...
            <div className="flex h-14 w-14 items-center justify-center border-2 border-ink transition-colors group-hover:bg-ink group-hover:text-paper">
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {rest.map((r, i) => (
          <Reveal key={r.title + i} delay={(i % 3) * 0.08}>
            <div className="group flex h-full flex-col justify-between border-2 border-ink p-6 transition-all hover:-translate-y-1 hover:shadow-[6px_6px_0_0_hsl(var(--ink))]">
