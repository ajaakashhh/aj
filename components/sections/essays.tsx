...
export function Essays() {
  ...
  return (
    <section id="essays" className="flex h-screen flex-col justify-center overflow-hidden bg-beam py-10 scroll-mt-20 sm:py-14">
      ...
      <Reveal delay={0.1}>
        <div className="container relative">
          ...
          <button
            ...
            className="absolute right-2 top-[38%] flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border-2 border-ink bg-ink text-paper shadow-[3px_3px_0_0_hsl(var(--ink))] transition-transform hover:translate-x-[1px] hover:translate-y-[calc(-50%+1px)]"
          >
