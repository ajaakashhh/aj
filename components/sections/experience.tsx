...
export function Experience() {
  return (
    <section id="experience" className="sticky top-0 z-50 flex h-screen flex-col justify-center overflow-hidden bg-paper py-6 scroll-mt-20 sm:py-8">
      <div className="container">
        <SectionLabel index="05" title="Work History" />
                ...
                <div>
                  ...
                  <div className="mt-2 flex flex-wrap gap-1.5">
                    {job.tags.slice(0, 4).map((t) => (
                      <span
                        key={t}
                        className="rounded-full border border-ink/30 px-2 py-0.5 font-sans text-[9px] font-bold uppercase tracking-wider text-muted-foreground transition-colors group-hover:border-ink group-hover:text-ink"
                      >
                        {t}
                      </span>
                    ))}
