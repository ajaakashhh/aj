...
export function Experience() {
  return (
    <section id="experience" className="flex min-h-[100svh] flex-col justify-center overflow-hidden bg-beam py-6 scroll-mt-20 sm:py-8">
          ...
          {work.map((job, i) => (
            <Reveal key={job.org} delay={i * 0.05}>
              <div className="group grid gap-2 border-b-2 border-ink py-3 md:grid-cols-[auto_1fr] md:gap-6 md:py-3">
                ...
                <div>
                  <p className="line-clamp-2 max-w-2xl font-serif text-sm leading-snug text-ink/80">
                    {job.body}
                  </p>
