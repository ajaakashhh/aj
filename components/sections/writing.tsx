...
export function Writing() {
  return (
    <section id="writing" className="sticky top-0 z-20 flex h-screen flex-col justify-start overflow-y-auto scroll-mt-20 border-y-2 border-ink bg-ink text-paper">
