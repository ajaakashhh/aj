...
export function Press() {
  ...
  return (
    <section id="press" className="sticky top-0 z-[70] flex h-screen flex-col justify-between overflow-hidden scroll-mt-20 border-t-2 border-ink bg-ink text-paper">
