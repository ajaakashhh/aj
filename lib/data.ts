...
export const work = [
  {
    ...
    current: true,
    body: "End-to-end reel production and government communications, spanning policy campaigns and political client work.",
  ...
  },
  {
    ...
    body: "Political journalism and ground reporting, paired with show production and social media strategy across six platforms.",
  ...
  },
  {
    ...
    body: "Cinema journalism and social media management, with hands-on post-production for YouTube Shorts.",
  ...
  },
  {
    ...
    body: "Digital marketing and e-commerce content writing, done under senior strategist supervision.",
